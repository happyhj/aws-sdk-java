...
public class EnterStandbyResult implements Serializable {
     ...
     * Standby mode.
     *
     * @return A list describing the activities related to moving instances into
     *         Standby mode.
     */
     ...
     * Standby mode.
     *
     * @param activities A list describing the activities related to moving instances into
     *         Standby mode.
     */
