...
/**
 * Describe Metric Filters Result JSON Unmarshaller
 */
public class DescribeMetricFiltersResultJsonUnmarshaller implements Unmarshaller<DescribeMetricFiltersResult, JsonUnmarshallerContext> {
    ...
    public DescribeMetricFiltersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("metricFilters", targetDepth)) {
                    context.nextToken();
                    describeMetricFiltersResult.setMetricFilters(new ListUnmarshaller<MetricFilter>(MetricFilterJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeMetricFiltersResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeMetricFiltersResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeMetricFiltersResultJsonUnmarshaller();
        return instance;
    }
}
