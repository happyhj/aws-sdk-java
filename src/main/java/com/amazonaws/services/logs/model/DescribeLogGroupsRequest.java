...
/**
 * Container for the parameters to the {@link com.amazonaws.services.logs.AWSLogs#describeLogGroups(DescribeLogGroupsRequest) DescribeLogGroups operation}.
 * <p>
...
public class DescribeLogGroupsRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getLogGroupNamePrefix() != null) sb.append("LogGroupNamePrefix: " + getLogGroupNamePrefix() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLogGroupsRequest == false) return false;
        DescribeLogGroupsRequest other = (DescribeLogGroupsRequest)obj;
        
        if (other.getLogGroupNamePrefix() == null ^ this.getLogGroupNamePrefix() == null) return false;
        if (other.getLogGroupNamePrefix() != null && other.getLogGroupNamePrefix().equals(this.getLogGroupNamePrefix()) == false) return false; 
