...
public class IllegalUpdateExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public IllegalUpdateExceptionUnmarshaller() {
        super(IllegalUpdateException.class);
    }
