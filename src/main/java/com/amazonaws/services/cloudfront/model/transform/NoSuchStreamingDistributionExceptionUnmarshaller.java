...
public class NoSuchStreamingDistributionExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public NoSuchStreamingDistributionExceptionUnmarshaller() {
        super(NoSuchStreamingDistributionException.class);
    }
