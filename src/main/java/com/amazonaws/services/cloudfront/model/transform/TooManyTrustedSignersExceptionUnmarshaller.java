...
public class TooManyTrustedSignersExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public TooManyTrustedSignersExceptionUnmarshaller() {
        super(TooManyTrustedSignersException.class);
    }
