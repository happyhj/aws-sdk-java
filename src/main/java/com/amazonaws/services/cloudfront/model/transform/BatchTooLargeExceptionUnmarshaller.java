...
public class BatchTooLargeExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public BatchTooLargeExceptionUnmarshaller() {
        super(BatchTooLargeException.class);
    }
