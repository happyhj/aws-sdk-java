...
public class DirectConnectServerExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("DirectConnectServerException"));
        } else {
            return errorTypeFromHeader.equals("DirectConnectServerException");
        }
    }
    ...
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        ...
        e.setErrorCode("DirectConnectServerException");
