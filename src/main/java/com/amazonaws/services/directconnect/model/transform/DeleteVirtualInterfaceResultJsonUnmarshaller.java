...
public class DeleteVirtualInterfaceResultJsonUnmarshaller implements Unmarshaller<DeleteVirtualInterfaceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("virtualInterfaceState", targetDepth)) {
                    context.nextToken();
                    deleteVirtualInterfaceResult.setVirtualInterfaceState(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static DeleteVirtualInterfaceResultJsonUnmarshaller instance;
    public static DeleteVirtualInterfaceResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteVirtualInterfaceResultJsonUnmarshaller();
        return instance;
    }
}
