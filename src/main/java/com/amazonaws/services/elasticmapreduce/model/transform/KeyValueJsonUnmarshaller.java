...
public class KeyValueJsonUnmarshaller implements Unmarshaller<KeyValue, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    keyValue.setKey(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    keyValue.setValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static KeyValueJsonUnmarshaller getInstance() {
        if (instance == null) instance = new KeyValueJsonUnmarshaller();
        return instance;
    }
}
