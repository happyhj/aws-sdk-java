...
public class StepTimelineJsonUnmarshaller implements Unmarshaller<StepTimeline, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CreationDateTime", targetDepth)) {
                    context.nextToken();
                    stepTimeline.setCreationDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("StartDateTime", targetDepth)) {
                    context.nextToken();
                    stepTimeline.setStartDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EndDateTime", targetDepth)) {
                    context.nextToken();
                    stepTimeline.setEndDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static StepTimelineJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StepTimelineJsonUnmarshaller();
        return instance;
    }
}
