...
public class InstanceGroupTimelineJsonUnmarshaller implements Unmarshaller<InstanceGroupTimeline, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CreationDateTime", targetDepth)) {
                    context.nextToken();
                    instanceGroupTimeline.setCreationDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ReadyDateTime", targetDepth)) {
                    context.nextToken();
                    instanceGroupTimeline.setReadyDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EndDateTime", targetDepth)) {
                    context.nextToken();
                    instanceGroupTimeline.setEndDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static InstanceGroupTimelineJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceGroupTimelineJsonUnmarshaller();
        return instance;
    }
}
