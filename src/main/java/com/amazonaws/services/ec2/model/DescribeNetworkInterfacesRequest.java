...
public class DescribeNetworkInterfacesRequest extends AmazonWebServiceRequest implements Serializable, DryRunSupportedRequest<DescribeNetworkInterfacesRequest> {
     ...
     * network interfaces.
     */
    private com.amazonaws.serviceinternal.ListWithAutoConstructFlag<String> networkInterfaceIds;
    ...
    public java.util.List<String> getNetworkInterfaceIds() {
        if (networkInterfaceIds == null) {
              networkInterfaceIds = new com.amazonaws.serviceinternal.ListWithAutoConstructFlag<String>();
    ...
    public void setNetworkInterfaceIds(java.util.Collection<String> networkInterfaceIds) {
        ...
        com.amazonaws.serviceinternal.ListWithAutoConstructFlag<String> networkInterfaceIdsCopy = new com.amazonaws.serviceinternal.ListWithAutoConstructFlag<String>(networkInterfaceIds.size());
