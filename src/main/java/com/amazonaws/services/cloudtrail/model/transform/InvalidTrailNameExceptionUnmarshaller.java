...
public class InvalidTrailNameExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("InvalidTrailNameException"));
        } else {
            return errorTypeFromHeader.equals("InvalidTrailNameException");
        }
    }
    ...
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        ...
        e.setErrorCode("InvalidTrailNameException");
