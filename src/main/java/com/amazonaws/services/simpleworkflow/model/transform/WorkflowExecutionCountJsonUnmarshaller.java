 ...
 */
public class WorkflowExecutionCountJsonUnmarshaller implements Unmarshaller<WorkflowExecutionCount, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("count", targetDepth)) {
                    context.nextToken();
                    workflowExecutionCount.setCount(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("truncated", targetDepth)) {
                    context.nextToken();
                    workflowExecutionCount.setTruncated(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static WorkflowExecutionCountJsonUnmarshaller getInstance() {
        if (instance == null) instance = new WorkflowExecutionCountJsonUnmarshaller();
        return instance;
    }
}
