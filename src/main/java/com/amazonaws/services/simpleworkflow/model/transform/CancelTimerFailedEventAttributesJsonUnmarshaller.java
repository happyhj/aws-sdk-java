 ...
 */
public class CancelTimerFailedEventAttributesJsonUnmarshaller implements Unmarshaller<CancelTimerFailedEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timerId", targetDepth)) {
                    context.nextToken();
                    cancelTimerFailedEventAttributes.setTimerId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    cancelTimerFailedEventAttributes.setCause(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CancelTimerFailedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CancelTimerFailedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
