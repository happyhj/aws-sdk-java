...
public class PipelineOutputConfigJsonUnmarshaller implements Unmarshaller<PipelineOutputConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Bucket", targetDepth)) {
                    context.nextToken();
                    pipelineOutputConfig.setBucket(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static PipelineOutputConfigJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PipelineOutputConfigJsonUnmarshaller();
        return instance;
    }
}
