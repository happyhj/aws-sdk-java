 ...
 */
public class ReadPipelineResultJsonUnmarshaller implements Unmarshaller<ReadPipelineResult, JsonUnmarshallerContext> {

    public ReadPipelineResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    public static ReadPipelineResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ReadPipelineResultJsonUnmarshaller();
        return instance;
    }
}
