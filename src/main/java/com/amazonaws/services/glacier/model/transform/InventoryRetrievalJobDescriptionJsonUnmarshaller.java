...
public class InventoryRetrievalJobDescriptionJsonUnmarshaller implements Unmarshaller<InventoryRetrievalJobDescription, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Format", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobDescription.setFormat(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("StartDate", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobDescription.setStartDate(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EndDate", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobDescription.setEndDate(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Limit", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobDescription.setLimit(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobDescription.setMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static InventoryRetrievalJobDescriptionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InventoryRetrievalJobDescriptionJsonUnmarshaller();
        return instance;
    }
}
