...
public class DeleteGatewayResultJsonUnmarshaller implements Unmarshaller<DeleteGatewayResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    deleteGatewayResult.setGatewayARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeleteGatewayResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteGatewayResultJsonUnmarshaller();
        return instance;
    }
}
