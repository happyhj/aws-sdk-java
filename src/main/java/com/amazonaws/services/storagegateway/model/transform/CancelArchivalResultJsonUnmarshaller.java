 ...
 */
public class CancelArchivalResultJsonUnmarshaller implements Unmarshaller<CancelArchivalResult, JsonUnmarshallerContext> {

    public CancelArchivalResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TapeARN", targetDepth)) {
                    context.nextToken();
                    cancelArchivalResult.setTapeARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CancelArchivalResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CancelArchivalResultJsonUnmarshaller();
        return instance;
    }
}
