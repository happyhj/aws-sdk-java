 ...
 */
public class UpdateGatewayInformationRequestMarshaller implements Marshaller<Request<UpdateGatewayInformationRequest>, UpdateGatewayInformationRequest> {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (updateGatewayInformationRequest.getGatewayTimezone() != null) {
                jsonWriter.key("GatewayTimezone").value(updateGatewayInformationRequest.getGatewayTimezone());
            }
