 ...
 */
public class CancelRetrievalResultJsonUnmarshaller implements Unmarshaller<CancelRetrievalResult, JsonUnmarshallerContext> {

    public CancelRetrievalResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TapeARN", targetDepth)) {
                    context.nextToken();
                    cancelRetrievalResult.setTapeARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CancelRetrievalResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CancelRetrievalResultJsonUnmarshaller();
        return instance;
    }
}
