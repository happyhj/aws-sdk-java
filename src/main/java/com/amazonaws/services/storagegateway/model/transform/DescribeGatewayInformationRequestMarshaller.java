 ...
 */
public class DescribeGatewayInformationRequestMarshaller implements Marshaller<Request<DescribeGatewayInformationRequest>, DescribeGatewayInformationRequest> {
    ...
    public Request<DescribeGatewayInformationRequest> marshall(DescribeGatewayInformationRequest describeGatewayInformationRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (describeGatewayInformationRequest.getGatewayARN() != null) {
                jsonWriter.key("GatewayARN").value(describeGatewayInformationRequest.getGatewayARN());
            }
