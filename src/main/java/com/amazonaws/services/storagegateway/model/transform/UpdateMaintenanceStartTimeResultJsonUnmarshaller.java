...
public class UpdateMaintenanceStartTimeResultJsonUnmarshaller implements Unmarshaller<UpdateMaintenanceStartTimeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    updateMaintenanceStartTimeResult.setGatewayARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static UpdateMaintenanceStartTimeResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateMaintenanceStartTimeResultJsonUnmarshaller();
        return instance;
    }
}
