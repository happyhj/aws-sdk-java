...
public class DeleteBandwidthRateLimitResultJsonUnmarshaller implements Unmarshaller<DeleteBandwidthRateLimitResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    deleteBandwidthRateLimitResult.setGatewayARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static DeleteBandwidthRateLimitResultJsonUnmarshaller instance;
    public static DeleteBandwidthRateLimitResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteBandwidthRateLimitResultJsonUnmarshaller();
        return instance;
    }
}
