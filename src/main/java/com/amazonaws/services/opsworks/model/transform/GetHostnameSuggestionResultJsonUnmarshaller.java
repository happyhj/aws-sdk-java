...
public class GetHostnameSuggestionResultJsonUnmarshaller implements Unmarshaller<GetHostnameSuggestionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LayerId", targetDepth)) {
                    context.nextToken();
                    getHostnameSuggestionResult.setLayerId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Hostname", targetDepth)) {
                    context.nextToken();
                    getHostnameSuggestionResult.setHostname(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetHostnameSuggestionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetHostnameSuggestionResultJsonUnmarshaller();
        return instance;
    }
}
