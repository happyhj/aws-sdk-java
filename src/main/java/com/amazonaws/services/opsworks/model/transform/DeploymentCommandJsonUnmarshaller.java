 ...
 */
public class DeploymentCommandJsonUnmarshaller implements Unmarshaller<DeploymentCommand, JsonUnmarshallerContext> {

    public DeploymentCommand unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DeploymentCommandJsonUnmarshaller instance;
    public static DeploymentCommandJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeploymentCommandJsonUnmarshaller();
        return instance;
    }
}
