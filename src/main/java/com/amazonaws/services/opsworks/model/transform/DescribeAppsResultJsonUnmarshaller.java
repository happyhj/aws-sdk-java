...
public class DescribeAppsResultJsonUnmarshaller implements Unmarshaller<DescribeAppsResult, JsonUnmarshallerContext> {
    ...
    private static DescribeAppsResultJsonUnmarshaller instance;
    public static DescribeAppsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeAppsResultJsonUnmarshaller();
        return instance;
    }
}
