...
public class SslConfigurationJsonUnmarshaller implements Unmarshaller<SslConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Certificate", targetDepth)) {
                    context.nextToken();
                    sslConfiguration.setCertificate(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("PrivateKey", targetDepth)) {
                    context.nextToken();
                    sslConfiguration.setPrivateKey(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Chain", targetDepth)) {
                    context.nextToken();
                    sslConfiguration.setChain(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static SslConfigurationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SslConfigurationJsonUnmarshaller();
        return instance;
    }
}
