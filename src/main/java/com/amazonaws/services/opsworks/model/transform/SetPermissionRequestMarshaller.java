        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (setPermissionRequest.getStackId() != null) {
                jsonWriter.key("StackId").value(setPermissionRequest.getStackId());
            }
            if (setPermissionRequest.getIamUserArn() != null) {
                jsonWriter.key("IamUserArn").value(setPermissionRequest.getIamUserArn());
            }
            if (setPermissionRequest.isAllowSsh() != null) {
                jsonWriter.key("AllowSsh").value(setPermissionRequest.isAllowSsh());
            }
