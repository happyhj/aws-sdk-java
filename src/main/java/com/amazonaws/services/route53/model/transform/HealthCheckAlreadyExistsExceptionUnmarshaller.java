...
public class HealthCheckAlreadyExistsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public HealthCheckAlreadyExistsExceptionUnmarshaller() {
        super(HealthCheckAlreadyExistsException.class);
    }
