...
public class InvalidChangeBatchExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidChangeBatchExceptionUnmarshaller() {
        super(InvalidChangeBatchException.class);
    }
