...
public class HealthCheckVersionMismatchExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public HealthCheckVersionMismatchExceptionUnmarshaller() {
        super(HealthCheckVersionMismatchException.class);
    }
