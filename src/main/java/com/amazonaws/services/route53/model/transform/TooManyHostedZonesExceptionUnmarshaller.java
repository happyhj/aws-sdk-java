...
public class TooManyHostedZonesExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public TooManyHostedZonesExceptionUnmarshaller() {
        super(TooManyHostedZonesException.class);
    }
