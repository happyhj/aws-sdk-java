...
public class NoSuchHealthCheckExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public NoSuchHealthCheckExceptionUnmarshaller() {
        super(NoSuchHealthCheckException.class);
    }
