...
public class DefineExpressionRequestMarshaller implements Marshaller<Request<DefineExpressionRequest>, DefineExpressionRequest> {
    ...
    public Request<DefineExpressionRequest> marshall(DefineExpressionRequest defineExpressionRequest) {
        ...
        Expression expressionExpression = defineExpressionRequest.getExpression();
        if (expressionExpression != null) {
            if (expressionExpression.getExpressionName() != null) {
                request.addParameter("Expression.ExpressionName", StringUtils.fromString(expressionExpression.getExpressionName()));
            }
            if (expressionExpression.getExpressionValue() != null) {
                request.addParameter("Expression.ExpressionValue", StringUtils.fromString(expressionExpression.getExpressionValue()));
            }
        }
