...
public class ClusterNotFoundExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public ClusterNotFoundExceptionUnmarshaller() {
        super(ClusterNotFoundException.class);
    }
