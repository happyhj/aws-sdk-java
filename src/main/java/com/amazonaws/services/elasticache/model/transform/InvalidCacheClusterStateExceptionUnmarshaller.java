...
public class InvalidCacheClusterStateExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidCacheClusterStateExceptionUnmarshaller() {
        super(InvalidCacheClusterStateException.class);
    }
