...
public class CacheClusterAlreadyExistsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public CacheClusterAlreadyExistsExceptionUnmarshaller() {
        super(CacheClusterAlreadyExistsException.class);
    }
