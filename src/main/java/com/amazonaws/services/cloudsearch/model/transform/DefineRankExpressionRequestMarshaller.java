...
public class DefineRankExpressionRequestMarshaller implements Marshaller<Request<DefineRankExpressionRequest>, DefineRankExpressionRequest> {
    ...
    public Request<DefineRankExpressionRequest> marshall(DefineRankExpressionRequest defineRankExpressionRequest) {
        ...
        if (defineRankExpressionRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils.fromString(defineRankExpressionRequest.getDomainName()));
        }
        NamedRankExpression namedRankExpressionRankExpression = defineRankExpressionRequest.getRankExpression();
        if (namedRankExpressionRankExpression != null) {
            if (namedRankExpressionRankExpression.getRankName() != null) {
                request.addParameter("RankExpression.RankName", StringUtils.fromString(namedRankExpressionRankExpression.getRankName()));
            }
            if (namedRankExpressionRankExpression.getRankExpression() != null) {
