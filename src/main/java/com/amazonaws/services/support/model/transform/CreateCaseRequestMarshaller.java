    ...
    public Request<CreateCaseRequest> marshall(CreateCaseRequest createCaseRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.serviceinternal.ListWithAutoConstructFlag<String> ccEmailAddressesList = (com.amazonaws.serviceinternal.ListWithAutoConstructFlag<String>)(createCaseRequest.getCcEmailAddresses());
