...
public class TaskNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("TaskNotFoundException"));
        } else {
            return errorTypeFromHeader.equals("TaskNotFoundException");
        }
    }
    ...
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        ...
        e.setErrorCode("TaskNotFoundException");
