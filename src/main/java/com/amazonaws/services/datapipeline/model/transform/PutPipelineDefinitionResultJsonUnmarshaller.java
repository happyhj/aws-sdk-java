 ...
 */
public class PutPipelineDefinitionResultJsonUnmarshaller implements Unmarshaller<PutPipelineDefinitionResult, JsonUnmarshallerContext> {
    ...
    private static PutPipelineDefinitionResultJsonUnmarshaller instance;
    public static PutPipelineDefinitionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PutPipelineDefinitionResultJsonUnmarshaller();
        return instance;
    }
}
