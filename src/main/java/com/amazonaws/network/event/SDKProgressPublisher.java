 ...
 */
package com.amazonaws.network.event;

import static com.amazonaws.network.event.ProgressEventType.HTTP_REQUEST_CONTENT_RESET_EVENT;
import static com.amazonaws.network.event.ProgressEventType.HTTP_RESPONSE_CONTENT_RESET_EVENT;
import static com.amazonaws.network.event.ProgressEventType.REQUEST_BYTE_TRANSFER_EVENT;
import static com.amazonaws.network.event.ProgressEventType.REQUEST_CONTENT_LENGTH_EVENT;
import static com.amazonaws.network.event.ProgressEventType.RESPONSE_BYTE_TRANSFER_EVENT;
import static com.amazonaws.network.event.ProgressEventType.RESPONSE_CONTENT_LENGTH_EVENT;
